...
namespace pr6.Services
{
    public class RegistrationService : IRegistrationService
    {
        ...
        {
            var userIsExists = await _context.Users.AnyAsync(u => u.Mail == userCredentials.Mail, cancellationToken);
            ...
            await _mailService.SendMailAsync(userCredentials.Mail, "Код для подтверждения регистрации", $"Ваш код для подтверждения регистрации: {code}.",cancellationToken);
        }
